...
public class Author extends TableImpl<AuthorRecord> {
     ...
     */
    public final TableField<AuthorRecord, Long> ID = createField(DSL.name("ID"), SQLDataType.BIGINT.nullable(false), this, "");
    ...
    /**
     * The column <code>AUTHOR.VERSION</code>.
     */
    public final TableField<AuthorRecord, Integer> VERSION = createField(DSL.name("VERSION"), SQLDataType.INTEGER.nullable(false), this, "");
